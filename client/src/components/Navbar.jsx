...
export default function Navbar() {
  ...
  return (
      <header className="sticky top-0 z-50 w-full border-b" style={{ backgroundColor: "#126936" }}> 
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-2">
            ...
            />
            <span className="font-bold text-xl hover:text-[#f4821f] ">Giddy Sports Hub</span>
          </Link>
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* User login */}
            <Link href="/admin/login" className= "hover:text-[#f4821f]">
