        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="JohnNdungu@gmail.com"
              required
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="text-gray-700 w-full border rounded-md px-3 py-2 focus:ring focus:ring-blue-300 hover:ring hover:ring-[#126936] transition"
